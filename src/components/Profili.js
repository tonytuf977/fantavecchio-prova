...
function Profilo() {
  ...
  const handleAccettaScambio = async (richiesta) => {
    try {
      ...
      await scambiaGiocatori(richiesta.squadraRichiedente, richiesta.squadraAvversaria, richiesta.giocatoriOfferti, richiesta.giocatoriRichiesti);
